...
var FORGE_DO█████████_RE = /(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/;
...
var error = function () {
    ...
    var message = 'FIREBASE █████████ ERROR: ' + buildLogMessage_.apply(void 0, tslib.__spreadArray([], tslib.__read(varArgs)));
...
var WebSocketConnection = /** @class */ (function () {
    ...
    WebSocketConnection.connectionURL_ = function (repoInfo, transportSessionId, lastSessionId, appCheckToken) {
        ...
        if (!util.isNodeSdk() &&
            ...
            location.hostname &&
            FORGE_DO█████████_RE.test(location.hostname)) {
...
function newRelativePath(outerPath, innerPath) {
    ...
    if (outer === null) {
        ...
        throw new Error('█████████ ERROR: innerPath (' +
            innerPath +
            ') is not within ' +
            'outerPath (' +
            outerPath +
...
function initStandalone(app, url, version, nodeAdmin) {
    ...
    return initStandalone$1({
        ...
        url: url,
        version: version,
        // firebase-admin-node's app.█████████ implements FirebaseAuthInternal interface
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        customAuthImpl: app.█████████,
        namespace: {
            Reference: Reference,
