...
var MultiFactorInfo = /** @class */ (function () {
    ...
    MultiFactorInfo.prototype.initFromServerResponse = function (response) {
        ...
        if (!factorId || !response || !response.mfaEnrollmentId) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.█████████_ERROR, '█████████ ASSERT FAILED: Invalid multi-factor info response');
        }
...
var MultiFactorSettings = /** @class */ (function () {
    ...
    function MultiFactorSettings(response) {
        ...
        if (!validator_1.isNonNullObject(response)) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.█████████_ERROR, '█████████ ASSERT FAILED: Invalid multi-factor response');
        }
...
var UserInfo = /** @class */ (function () {
    ...
    function UserInfo(response) {
        ...
        if (!response.rawId || !response.providerId) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.█████████_ERROR, '█████████ ASSERT FAILED: Invalid user info response');
        }
...
var UserRecord = /** @class */ (function () {
    ...
    function UserRecord(response) {
        ...
        if (!response.localId) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.█████████_ERROR, '█████████ ASSERT FAILED: Invalid user response');
        }
