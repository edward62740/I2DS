...
var MultiFactorAuthConfig = /** @class */ (function () {
    ...
    function MultiFactorAuthConfig(response) {
        ...
        if (typeof response.state === 'undefined') {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.█████████_ERROR, '█████████ ASSERT FAILED: Invalid multi-factor configuration response');
        }
...
var EmailSignInConfig = /** @class */ (function () {
    ...
    function EmailSignInConfig(response) {
        if (typeof response.allowPasswordSignup === 'undefined') {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.█████████_ERROR, '█████████ ASSERT FAILED: Invalid email sign-in configuration response');
        }
...
var SAMLConfig = /** @class */ (function () {
    ...
    function SAMLConfig(response) {
        if (!response ||
            ...
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.█████████_ERROR, '█████████ ASSERT FAILED: Invalid SAML configuration response');
        }
...
var OIDCConfig = /** @class */ (function () {
    ...
    function OIDCConfig(response) {
        if (!response ||
            ...
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.█████████_ERROR, '█████████ ASSERT FAILED: Invalid OIDC configuration response');
        }
