...
var FirebaseTokenGenerator = /** @class */ (function () {
    ...
    function FirebaseTokenGenerator(signer, tenantId) {
        ...
        if (!validator.isNonNullObject(signer)) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CREDENTIAL, '█████████ ASSERT: Must provide a CryptoSigner to use FirebaseTokenGenerator.');
        }
...
function handleCryptoSignerError(err) {
    ...
    if (err.code === crypto_signer_1.CryptoSignerErrorCode.SERVER_ERROR && validator.isNonNullObject(err.cause)) {
        ...
        return new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.█████████_ERROR, 'Error returned from server: ' + errorResponse + '. Additionally, an ' +
...
function mapToAuthClientErrorCode(code) {
    switch (code) {
        ...
        default:
            return error_1.AuthClientErrorCode.█████████_ERROR;
    }
}
