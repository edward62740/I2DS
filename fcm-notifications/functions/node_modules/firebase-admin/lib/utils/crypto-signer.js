    ...
    function ServiceAccountSigner(credential) {
        ...
        if (!credential) {
            throw new CryptoSignerError({
                ...
                message: '█████████ ASSERT: Must provide a service account credential to initialize ServiceAccountSigner.',
            });
        }
    }
    /**
...
var IAMSigner = /** @class */ (function () {
    function IAMSigner(httpClient, serviceAccountId) {
        ...
        if (!httpClient) {
            throw new CryptoSignerError({
                ...
                message: '█████████ ASSERT: Must provide a HTTP client to initialize IAMSigner.',
            });
        }
        if (typeof serviceAccountId !== 'undefined' && !validator.isNonEmptyString(serviceAccountId)) {
            throw new CryptoSignerError({
                code: CryptoSignerErrorCode.INVALID_ARGUMENT,
                message: '█████████ ASSERT: Service account ID must be undefined or a non-empty string.',
            });
        }
    ...
    IAMSigner.prototype.getAccountId = function () {
        ...
        return client.send(request).then(function (response) {
            if (!response.text) {
                throw new CryptoSignerError({
                    code: CryptoSignerErrorCode.█████████_ERROR,
...
var CryptoSignerErrorCode = /** @class */ (function () {
    ...
    CryptoSignerErrorCode.█████████_ERROR = 'internal-error';
