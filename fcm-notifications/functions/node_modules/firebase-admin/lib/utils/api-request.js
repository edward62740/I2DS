...
var DefaultHttpResponse = /** @class */ (function () {
    ...
    function DefaultHttpResponse(resp) {
        ...
        try {
            if (!resp.data) {
                throw new error_1.FirebaseAppError(error_1.AppErrorCodes.█████████_ERROR, 'HTTP response missing data.');
            }
...
var HttpClient = /** @class */ (function () {
    ...
    HttpClient.prototype.backOffDelayMillis = function (retryAttempts) {
        ...
        if (!this.retry) {
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.█████████_ERROR, 'Expected this.retry to exist.');
        }
...
function parseHttpResponse(response, config) {
    ...
    if (!validator.isNumber(lowLevelResponse.status)) {
        throw new error_1.FirebaseAppError(error_1.AppErrorCodes.█████████_ERROR, 'Malformed HTTP status line.');
    }
...
var AsyncHttpCall = /** @class */ (function () {
    ...
    AsyncHttpCall.prototype.handleResponse = function (res, req) {
        ...
        if (!res.statusCode) {
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.█████████_ERROR, 'Expected a statusCode on the response from a ClientRequest');
        }
        var response = {
