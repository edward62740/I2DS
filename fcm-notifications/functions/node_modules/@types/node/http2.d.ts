...
declare module 'http2' {
    ...
    export interface ServerHttp2Stream extends Http2Stream {
         ...
         * closed using an `RST_STREAM` frame using the standard `█████████_ERROR` code.
         *
         ...
         * of the given file:
         *
         * If an error occurs while attempting to read the file data, the `Http2Stream`will be closed using an `RST_STREAM` frame using the standard `█████████_ERROR`code. If the `onError` callback is
    ...
    export interface Http2Session extends EventEmitter {
         ...
         * @param code The HTTP/2 error code to send in the final `GOAWAY` frame. If unspecified, and `error` is not undefined, the default is `█████████_ERROR`, otherwise defaults to `NO_ERROR`.
         */
    ...
    export namespace constants {
        ...
        const HTTP_STATUS_█████████_SERVER_ERROR: number;
