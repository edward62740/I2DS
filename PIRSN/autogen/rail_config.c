...
static const uint8_t hfxoRetimingConfigEntries[] = {
  1, 0, 0, 0, 0x00, 0x5a, 0x62, 0x02, 4, 12, 0, 0, 0xe0, 0x02, 0, 0, 0, 0, 0x3c, 0x03, 1, 2, 5, 4, 0x98, 0x03, 1, 2, 5, 5, 0xf4, 0x03, 1, 2, 6, 5
};
